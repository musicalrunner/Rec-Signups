...
app.get('/setup/batchAddCamper', routes.addCamper);
app.post('/setup/addingCamper', routes.addingCamper);
app.post('/setup/batchAddingCamper', routes.addingCamper);
app.get('/setup/addRec', routes.addRec);
app.post('/setup/addingRec', routes.addingRec);
app.get('/setup/batchAddRec', routes.addRec);
app.post('/setup/batchAddingRec', routes.addingRec);
